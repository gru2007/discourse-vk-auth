...
describe 'VK Oauth2' do
  ...
  before do
    ...
    stub_request(:get, "https://api.vk.com/method/users.get?access_token=#{access_token}&fields=nickname,screen_name,sex,city,country,online,bdate,photo_50,photo_100,photo_200,photo_200_orig,photo_400_orig&https=0&lang=&v=5.107")
      .to_return(
        status: 200,
        body: JSON.dump(
          response: [
